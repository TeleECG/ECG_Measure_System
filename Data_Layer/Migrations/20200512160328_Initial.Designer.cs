...
namespace Data_Layer.Migrations
{
    ...
    [Migration("20200512160328_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data_Layer.Data.ECGLeads", b =>
                {
            ...
            modelBuilder.Entity("Data_Layer.Data.ECGMeasurements", b =>
                {
                    b.Property<int>("ECGMeasurementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Data_Layer.Data.PatientMeasurements", b =>
                {
                    b.Property<int>("PatientMeasurementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Data_Layer.Data.ECGLeads", b =>
                {
                    b.HasOne("Data_Layer.Data.ECGMeasurements", "ECGMeasurement")
                        .WithMany("ECGLeads")
            ...
            modelBuilder.Entity("Data_Layer.Data.ECGMeasurements", b =>
                {
                    b.HasOne("Data_Layer.Data.PatientMeasurements", "PatientMeasurement")
